    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('badge', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='students_badges', to='badges.badge')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='students_badges', to='badges.student')),
            ],
        ),
    ]
